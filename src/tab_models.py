# this is a file that contains the deep learning models for the tabs data type 
import warnings
# can you import all the depencies here
...
class SimpleMLP(nn.Module):
    def __init__(self, input_size, hidden_layers, num_classes, dropout_rates, norm_type='batchnorm'):
        super().__init__()
        layers = []
        ...
        # Output layer
        layers.append(nn.Linear(previous_layer_size, num_classes))
